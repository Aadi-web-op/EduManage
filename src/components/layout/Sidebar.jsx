...
export const Sidebar = () => {
    ...
    return (
        <motion.aside
            ...
            className="fixed top-0 left-0 z-50 flex flex-col bg-white/60 dark:bg-[#1a1c23]/80 backdrop-blur-2xl border-r border-white/40 dark:border-white/5 h-screen transition-all duration-400 ease-out shadow-[12px_0_51px_rgba(0,0,0,0.05)]"
        >
            <div className="flex items-center p-6 h-24 overflow-hidden shrink-0">
            ...
            <div className="flex-1 px-4 py-6 space-y-3 overflow-y-auto custom-scrollbar">
                {navItems.map((item) => {
                    ...
                    return (
                        <button
                            ...
                            className={`w-full flex items-center px-3 py-3.5 rounded-[14px] transition-all duration-300 relative overflow-hidden group ${isActive
                                ? 'bg-white dark:bg-white/10 text-[#384959] dark:text-white shadow-sm border border-white/60 dark:border-white/5'
